...
from pkg_task1.msg import msgTurtleResult  # used for Result messages
from pkg_task1.msg import msgTurtleFeedback  # used for Feedback messages
...
class SimpleActionServerTurtle:
    ...
    def __init__(self):
        ...
        self._sas = actionlib.SimpleActionServer('/action_turtle',
                                                 ...
                                                 auto_start=False)
        '''
        * '/action_turtle' - The name of the action that will be used by ROS 
        Nodes to communicate with this Simple Action Server.
        ...
        * auto_start = False - Only when self._sas.start() will be called then 
        only this Simple Action Server will start.
        '''
    ...
    def func_move_straight(self, param_dis, param_speed, param_dir):
        ...
        # Move the turtle till it reaches the desired position by publishing to
        # Velocity topic
    ...
    def func_rotate(self, param_degree, param_speed, param_dir):
        ...
        if param_dir == 'a':
            obj_velocity_msg.angular.z = math.radians(
...
def main():
    ...
    handle_sub_pose = rospy.Subscriber(obj_server._config_ros_sub_topic,
                                       Pose,
